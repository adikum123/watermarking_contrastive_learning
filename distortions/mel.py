...
class MelFilterBankLayer(nn.Module):
    ...
    def forward(self, stft_output):
        ...
        target_dtype = self.mel_filter_bank.dtype
        stft_output_reshaped = stft_output_reshaped.to(dtype=target_dtype)
...
def test_mel_layer():
    ...
    waveform = torch.randn(1, 44100)  # Simulate a random waveform for testing
